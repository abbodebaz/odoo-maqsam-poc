{
    ...
    "license": "LGPL-3",
    "depends": ["base", "base_setup", "web", "contacts", "crm", "sale_management", "account", "project", "base_automation"],
    "data": [
        ...
        "views/crm_wati_views.xml",
        "views/sale_wati_views.xml",
        "views/account_wati_views.xml",
        "views/project_wati_views.xml",
